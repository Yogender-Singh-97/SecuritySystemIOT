        ...
        .then(function (pid) {
          ...
          for (let i = 0; i < params.checkpoint_id.length; i++) {
            ...
            db.patrol_params.create({
              patrol_id: pid.patrol_id, checkpoint_id: params.checkpoint_id[i], lower_bound_time: lower_bound_time,
...
module.exports = {
  guard_password_reset, enable_guard, disable_guard, delete_guard, guard_register_get, isAuthenticated, guard_save, guard_manage, update_guard1, update_guard2,
